...
public class SettingClearConditionFragment extends AppCompatDialogFragment {
    ...
    interface OnClearConditionDialogClickListener {
         ...
         */
        void onPositiveClick(final int conditionIndex, final int conditionNumIndex);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton(R.string.dialog_positive, (dialogInterface, i) -> {
            ...
            mListener.onPositiveClick(conditionIndex, conditionNumIndex);
        });
    ...
    private void init(final View view) {
        ...
        mConditionSpinner.setOnItemClickListener((adapterView, view1, position, id) -> {
